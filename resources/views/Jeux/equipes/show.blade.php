                ...
                <form action="{{ route('equipes.ajouter') }}" method="POST" enctype="multipart/form-data" class="admin-form">
                    ...
                    <div class="form-row">
                        <div class="form-group-admin">
                            <label for="nom_équipe">Nom de l'équipe</label>
                            <input type="text" id="nom_équipe" name="nom_équipe" placeholder="Ex: Karmine Corp" required>
                        </div>
            ...
            @foreach($equipes as $equipe)
                <div class="team-card">
                    <div class="team-header">
                        @if ($equipe->id != 6)
                            <img src="{{ asset('images/logo_équipes/' . $equipe->logo_url) }}"
